...
export const selectAdminUsersListCount = createSelector(
  selectUsers,
  (state) => state.users.count
);

export const selectAdminUsersRoles = createSelector(
  selectUsers,
...
export const selectAdminUsersErrorMessage = createSelector(
  selectUsers,
  (state) => state.users.errorMessage
);

export const selectAdminCurrentUser = createSelector(
  selectUsers,
  (state) => state.currentUser.user
);

export const selectAdminCurrentUserIsLoading = createSelector(
  selectUsers,
  (state) => state.currentUser.isLoading
);

export const selectAdminCurrentUserErrorMessage = createSelector(
  selectUsers,
