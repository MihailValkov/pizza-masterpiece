...
export const selectAdminOrdersListCount = createSelector(
  selectOrders,
...
export const selectAdminOrdersErrorMessage = createSelector(
  selectOrders,
...
export const selectAdminCurrentOrderIsLoading = createSelector(
  selectOrders,
  (state) => state.currentOrder.isLoading
);
