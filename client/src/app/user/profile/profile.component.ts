...
export class ProfileComponent {
  ...
  uploadImageIsLoading$ = this.store.pipe(select(selectors.selectUpdateUserImageIsLoading));
  updateUserInfoIsLoading$ = this.store.pipe(select(selectors.selectUpdateUserInfoIsLoading));
  updateUserAddressIsLoading$ = this.store.pipe(select(selectors.selectUpdateUserAddressIsLoading));
  updateUserPasswordIsLoading$ = this.store.pipe(select(selectors.selectUpdateUserPasswordIsLoading));
